...
public interface CommProtocolDirectionRegisters {

  public static final char[] PORT_A_COMMAND = new char[] {
      '!', 'A'};
  public static final char[] PORT_B_COMMAND = new char[] {
      '!', 'B'};
  public static final char[] PORT_C_COMMAND = new char[] {
      '!', 'C'};
